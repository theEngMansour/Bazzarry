                ...
                <div class="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 mt-6">
                    <?php foreach($projects as $project) : ?>
                        <div class="w-full max-w-sm mx-auto rounded-md shadow-md overflow-hidden">
                            <div class="flex items-end justify-end h-56 w-full bg-cover" style="background-image: url('https://bazzarry.com/pub/media/catalog/product/cache/9693cd8fc19bed9d613c29706111b0de/3/0/30015041.jpg')">
                            ...
                            <img src="<?= $project->cover_image ?>" alt="" srcset="">
                            <div class="px-5 py-3">
